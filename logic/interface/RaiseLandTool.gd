...
func _draw() -> void:
	_can_build_last_frame = Root.construction_manager.can_raise_land(cell_under_mouse)
...
func _needs_redraw() -> bool:
	return _can_build_last_frame != Root.construction_manager.can_raise_land(cell_under_mouse)
